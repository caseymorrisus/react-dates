...
function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    _this.getModifiers = _this.getModifiers.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(CalendarMonth, [{
    ...
    key: "getModifiers",
    value: function getModifiers(day) {
      var mods = this.props.modifiers[(0, _toISODateString["default"])(day)];
      if (mods) mods["delete"]('hovered');
      return typeof mods !== 'undefined' ? this.props.modifiers[(0, _toISODateString["default"])(day)] : mods;
    }
  }, {
    key: "render",
      ...
      return _react["default"].createElement("div", _extends({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
        ...
        return _react["default"].createElement(_CalendarWeek["default"], {
          ...
          return renderCalendarDay({
            ...
            phrases: phrases,
            modifiers: _this2.getModifiers(day),
